...
class SegmentLCTMatchBox {
 ...
 public:
  ...
  bool isMatched ( const CSCSegment &segment, std::vector<edm::Ref<std::vector<L1TMuon::TriggerPrimitive> > >, int *match_analysis = 0 );
  ...
  int whichMode ( const CSCSegment &segment, edm::Handle< vector<L1TMuon::TriggerPrimitive> >, int *match_analysis = 0 );
