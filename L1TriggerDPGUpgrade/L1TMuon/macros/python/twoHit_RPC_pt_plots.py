...
if twoHit:
    ...
    header = 'Simulation(Single Muon), All Q, CSCTF P_{t} > 3 , Two Hit CSCTF Tracks(1-3)'
    title = 'twoHit'

if threeHit:
    file = TFile('threeHit_RPC_pt_plots.root')
    header = 'Simulation(Single Muon), All Q, CSCTF P_{t} > 3 , Three Hit CSCTF Tracks(1-2-3)'
    title = 'threeHit'
...
if eff:
    ...
    c7.SaveAs('plots/efficiency_16GeV_'+title+'.pdf')
